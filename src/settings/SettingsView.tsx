      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4 mb-6">
        <div className="flex items-center space-x-4">
          <div className="flex-1">
            <h2 className="text-lg font-medium">Repo {scope.repo}</h2>
            <p className="text-sm text-gray-600">Branch {scope.branch}</p>
          </div>
        </div>
      </div>
          ...
          {activeTab === 'napps' && (
            <div>
              ...
              <div className="space-y-3">
                ...
                {napps.length === 0 && (
                  <div className="text-center py-6 text-gray-500">
                    No natural applications installed. Install an application to
                    get started.
                  </div>
                )}
              </div>
